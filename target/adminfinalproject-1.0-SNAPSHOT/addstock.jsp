    ...
    <tr>
        <td>
            ...
            <form action="mainPage" METHOD="POST">
                ...
                <table>
                    <tr>
                        <b>Fill in the fields to add a new ingredient!</b>
                    </tr>
                    <br/><br/>
                    <tr><input type="text" name="idingradienta" placeholder="Ingredient ID" size="50"
                               align="left">
                    </tr>
                    <br/><br/>
                    <tr><input type="text" name="nameingradienta" placeholder="Name ingredient" size="50"
                               align="left">
                    </tr>
                    <br/><br/>
                    <tr><input type="text" name="quantity" placeholder="Quantity" size="50"
                               align="left">
                    <br/><br/>
                    <tr><input TYPE="submit" name="addstock" value="Add ingredient"
